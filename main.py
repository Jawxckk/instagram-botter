...
def __main__:
 ...
 print("");print("[1] - Likes ");print("");print("[2] - Views ");print("");print("[1] - Followers ");print("");
   choose=input('> ')
     ...
     else if choose="2": 1000000099
       url=input("https://www.instagram.com/p/C2qKrVhp8E2/?igsh=a2d2cGI0b254enF0 (need to be public and can be found on instagram's computer version")
          if req.url==False:
       print('cannot find the story/account')
       else: 
       req.url("https://www.instagram.com/stories/%@ja.wxckk%/%url%/")
       req.new accounts 
             def __gen__:
